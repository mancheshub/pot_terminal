...
import com.bigsize.pot_terminal.databinding.BoxShippingListview01Binding

class BoxShipping(val context:Context?,var itemList:MutableList<PotDataModel01> ):BaseAdapter() {
  ...
  override fun getView( position:Int, convertView:View?, parent:ViewGroup ):View {
    ...
    lateinit var binding01:BoxShippingListview01Binding

    // 表示部品をなければ作ってあれば再利用します

    if( itemView == null ) {
      binding01 = DataBindingUtil.inflate( inflater, R.layout.box_shipping_listview01, parent, false );
      ...
      binding01 = itemView!!.tag as BoxShippingListview01Binding
    }
