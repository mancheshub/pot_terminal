...
class ShelfReceiving:DensoWaveBase() {
  private val binding01:ShelfReceivingBinding by dataBinding()
  private val viewModel01:VM_ShelfReceiving by viewModels()
  ...
  override fun onCreate( savedInstanceState:Bundle? ) {
    ...
    scanShelf.observe( this, Observer<String> {
      if( BuildConfig.DEBUG ) Log.d( "APP-ShelfReceiving", "棚データ = " + scanShelf.value )
    ...
    scanItemM.observe( this, Observer<String> {
      if( BuildConfig.DEBUG ) Log.d( "APP-ShelfReceiving", "商品データ = " + scanItemM.value )
